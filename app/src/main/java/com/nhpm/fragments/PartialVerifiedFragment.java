 ...
 * Use the {@link PartialVerifiedFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PartialVerifiedFragment extends Fragment {
    ...
    public PartialVerifiedFragment() {
    ...
    public static PartialVerifiedFragment newInstance(String param1, String param2) {
        PartialVerifiedFragment fragment = new PartialVerifiedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_partial_verified, container, false);
        setupScreen(view);
        return view;
    }
...
*/
    ...
    class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder   {
            ...
            TextView cname,idd;
            ImageView next;
            TextView nameTV,genderTV,fatherNameTV,addressTV,houseNoTV,updateStatTV;
            Button sendBT,getErrorBT;
            public MyViewHolder(View itemView) {
                ...
                getErrorBT=(Button)itemView.findViewById(R.id.getErrorBT);
                updateStatTV=(TextView)itemView.findViewById(R.id.updateStatTV);
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent,
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.offline_member_item, parent, false);
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
            ...
            if(listPosition==0){
                ...
                holder.getErrorBT.setVisibility(View.GONE);
               // holder.updateStatTV.setVisibility(View.VISIBLE);
            }else if(listPosition==1){
                holder.sendBT.setVisibility(View.VISIBLE);
                holder.getErrorBT.setVisibility(View.GONE);
                //holder.updateStatTV.setVisibility(View.VISIBLE);
            }else{
                holder.getErrorBT.setVisibility(View.VISIBLE);
              //  holder.updateStatTV.setVisibility(View.VISIBLE);
               // holder.updateStatTV.setText("Partially Updated");
            }
