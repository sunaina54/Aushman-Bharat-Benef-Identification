 ...
 * {@link SubmittedFragment.OnFragmentInteractionListener} interface
...
public class SubmittedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragement_submitted_layout, container, false);
        setupScreen(view);
        return view;
    }
   ...
   */
      //  getSECCDataForSearchSpinner();
        ...
        sendAllBT=(Button)view.findViewById(R.id.eSignBT);
        // prepareData();
...
*/
   ...
   private class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder   {
           TextView nameTV,houseNoTV,aadhaarTV,nhpsIdTV;
            ...
            public MyViewHolder(View itemView) {
                ...
                printBT=(Button)itemView.findViewById(R.id.printBT);
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent,
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.row_submit_layout, parent, false);
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
            ...
            if(listPosition==0){
                holder.printBT.setVisibility(View.VISIBLE);
                holder.nhpsIdTV.setVisibility(View.VISIBLE);
            }
