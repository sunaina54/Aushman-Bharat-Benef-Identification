...
/**
 * Created by Sauarbh on 24-03-2017.
 */

public class HouseholdStatusBoardRsbyFragment extends Fragment {
    ...
    public HouseholdStatusBoardRsbyFragment() {
    ...
    public static HouseholdStatusBoardRsbyFragment newInstance(String param1, String param2) {
        HouseholdStatusBoardRsbyFragment fragment = new HouseholdStatusBoardRsbyFragment();
    ...
    private void setupScreen(View view) {
        ...
        if (location != null) {
            if (downloadSource != null && downloadSource.equalsIgnoreCase(AppConstant.WardWiseDownloading)) {
                houseHoldList = SeccDatabase.getRSBYHouseHoldListWardWise(location.getStateCode(), location.getDistrictCode(),
                        location.getTehsilCode(), location.getVtCode(), location.getWardCode(), context);
            } else if (downloadSource != null && downloadSource.equalsIgnoreCase(AppConstant.VillageWiseDownloading)) {
                houseHoldList = SeccDatabase.getRSBYHouseHoldListVillageWise(location.getStateCode(), location.getDistrictCode(),
                        location.getTehsilCode(), location.getVtCode(), context);
            } else if (downloadSource != null && downloadSource.equalsIgnoreCase(AppConstant.EbWiseDownloading)) {
                houseHoldList = SeccDatabase.getRSBYHouseHoldList(location.getStateCode(), location.getDistrictCode(),
