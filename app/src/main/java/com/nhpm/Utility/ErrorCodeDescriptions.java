...
public class ErrorCodeDescriptions {
    ...
    static {
        ...
        codeToDescriptionMap.put("551", "Invalid “tid” value");


        codeToDescriptionMap.put("553" ,"Registered devices currently not supported. This feature is being implemented in a phased manner");
        codeToDescriptionMap.put("554", "Public devices are not allowed to be used");
        codeToDescriptionMap.put("555", "rdsId is invalid and not part of certification registry");
        codeToDescriptionMap.put("556","rdsVer is invalid and not part of certification registry");
        codeToDescriptionMap.put("557","dpId is invalid and not part of certification registry");
        codeToDescriptionMap.put("558","Invalid dih");
        codeToDescriptionMap.put("559","Device Certificat has expired");


        codeToDescriptionMap.put("560","DP Master Certificate has expired");
        ...
        codeToDescriptionMap.put("586",  "FID usage not allowed as per license. This feature is being implemented in a phased manner");
        codeToDescriptionMap.put("587", "Name space not allowed");
        codeToDescriptionMap.put("588", "Registered device not allowed as per license");
        ...
        codeToDescriptionMap.put("822", "Invalid value in the “bs” attribute of “Bio” element within “Pid”");
        ...
        codeToDescriptionMap.put("951", "Biometric lock related technical error");

        codeToDescriptionMap.put("980", "Unsupported option");

        codeToDescriptionMap.put("995", "Aadhaar suspended by competent authority.");
        codeToDescriptionMap.put("996", "Aadhaar cancelled (Aadhaar is no in authenticable status)");
        codeToDescriptionMap.put("997", "Aadhaar suspended (Aadhaar is not in authenticatable status)");
        codeToDescriptionMap.put("998", "Invalid Aadhaar Number.");
        codeToDescriptionMap.put("999", "Unknown error");

        // KYC error descriptions

        codeToDescriptionMap.put("K-100", "Resident authentication failed");
        codeToDescriptionMap.put("K-200", "Resident data currently not available");
        codeToDescriptionMap.put("K-540", "Invalid KYC request XML");
        codeToDescriptionMap.put("K-541", "Invalid KYC API version");
        codeToDescriptionMap.put("K-542", "Invalid resident consent (�rc� attribute in �Kyc� element)");
        codeToDescriptionMap.put("K-543", "Invalid timestamp (�ts� attribute in �Kyc� element)");
        codeToDescriptionMap.put("K-544", "Invalid resident auth type (�ra� attribute in �Kyc� element)");
        codeToDescriptionMap.put("K-545", "Resident opted out of service");
        codeToDescriptionMap.put("K-550", "Invalid uses attributes");
        codeToDescriptionMap.put("K-551", "Invalid KYC transaction");
        codeToDescriptionMap.put("K-552", "Invalid license key");
        codeToDescriptionMap.put("K-569", "XML signature verification failed");
        codeToDescriptionMap.put("K-570", "Invalid signature info");
        codeToDescriptionMap.put("K-600", "AUA is invalid or not an authorized KUA");
        codeToDescriptionMap.put("K-601", "ASA is invalid or not an authorized KSA");
        codeToDescriptionMap.put("K-955", "Technical error while processing");
        codeToDescriptionMap.put("K-999", "Unknown error while processing");
