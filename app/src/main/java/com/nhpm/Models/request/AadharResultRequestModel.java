...
/**
 * Created by Dell3 on 11-05-2018.
 */

public class AadharResultRequestModel implements Serializable {
    private String uid;
    private String name;
    private String dob;
    ...
    static public AadharResultRequestModel create(String serializedData) {
        // Use GSON to instantiate this class using the JSON representation of the state
        Gson gson = new Gson();
        return gson.fromJson(serializedData, AadharResultRequestModel.class);
    }
