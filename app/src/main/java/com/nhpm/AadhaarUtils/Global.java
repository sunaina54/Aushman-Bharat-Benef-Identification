...
public class Global {
    ...
    public static String DEMO_AUTH_OLD = "http://164.100.58.98:80/getAuth/1.0.0/getAuth";
    public static String DEMO_AUTH = "http://164.100.58.98:80/getDemoAuthRD/1.0.0/getDemoAuthRD";
    ...
    public static String TXN_FOR_AUTH = "";
