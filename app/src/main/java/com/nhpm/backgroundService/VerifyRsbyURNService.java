 ...
 */
public class VerifyRsbyURNService extends IntentService {
    private SeccMemberItem seccMemberItem;
    private String TAG="VERIFY AADHAAR SERVICE";

    public VerifyRsbyURNService(){
        super(VerifyRsbyURNService.class.getName());
    }
    @Override
    protected void onHandleIntent(Intent intent) {
        seccMemberItem=(SeccMemberItem)intent.getSerializableExtra("RSBYUrn");
